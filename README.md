...
Если у вас уже настроен Telegram Bot как `notify` сервис, он будет доступен в выпадающем списке. Интеграция сохраняет только имя сервиса внутри домена `notify`.
